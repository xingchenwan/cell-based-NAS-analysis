...
class Eval:
    ...
    def __init__(self, image_data_path='./', dataset='cifar10'):
        ...
        self.batch_size = 96        # 128 if using PCDarts hyperparams
        ...
        self.drop_path_prob = 0.2       # 0.3 if using PCDarts hyperparams
        self.seed = 0
        self.grad_clip = 5
        ...
        if dataset == 'cifar10':
            ...
            self.weight_decay = 5e-4        # Following PDARTS Protocols
        else:
    ...
    def main(self, arch, epochs=600, gpu=0, load_weights=False, train_portion=0.8, seed=0,
        ...
        print('arch: {}, epochs: {}, gpu: {}, load_weights: {},'
              .format(arch, epochs, gpu, load_weights, ))
        ...
        test_queue = torch.utils.data.DataLoader(
            test_data, batch_size=self.batch_size // 2, shuffle=False, pin_memory=True, num_workers=2)
        ...
        for epoch in range(self.epochs):
            ...
            if epoch % 10 == 0:
                arch_results = {
                    ...
                    'full_valid_runtime': train_runtimes,
                }
